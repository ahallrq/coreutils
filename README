...
Intended to be a re-implementation of various coreutils for the purpose of learning C.

Beware: Don't expect 100% compatibility with the GNU or busybox equivalents.
